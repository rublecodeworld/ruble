...
Makefile: ruble-qt.pro ../../qt/5.3.1/mkspecs/win32-g++/qmake.conf ../../qt/5.3.1/mkspecs/features/spec_pre.prf \
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\ruble\ruble\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\ruble\ruble\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\ruble\ruble\ruble-qt_plugin_import.cpp

C:/ruble/ruble/src/leveldb/libleveldb.a: FORCE
